...
<head>
    ...
    <title>GoodGames | Website Offline</title>
...
<body>
    ...
    <div class="nk-main">
        ...
        <div class="nk-fullscreen-block">
            ...
            <div class="nk-fullscreen-block-middle nk-vertical-center">
                <div class="container text-xs-center">
                    <div class="row">
                        <div class="col-md-6 offset-md-3 col-lg-4 offset-lg-4">
                            <h1 class="h2">
                                <span class="text-main-1">Site is</span> Offline</h1>
                            ...
                            <form action="//nkdev.us11.list-manage.com/subscribe/post?u=d433160c0c43dcf8ecd52402f&amp;id=7eafafe8f0" method="post" class="nk-mchimp validate" target="_blank">
                                <div class="input-group">
                                    ...
                                    <span class="nk-input-group-btn pl-20">
                                        <button class="nk-btn nk-btn-rounded nk-btn-color-white">Subscribe</button>
                                    </span>
                                </div>
