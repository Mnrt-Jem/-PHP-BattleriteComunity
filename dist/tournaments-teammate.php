            ...
            <div class="row equal-height vertical-gap">
                <div class="col-lg-8">
                                        ...
                                        <td>
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <strong class="h5">Name:</strong>&nbsp;&nbsp;&nbsp;</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <strong class="h5">Nickname:</strong>&nbsp;&nbsp;&nbsp;</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <strong class="h5">Position:</strong>&nbsp;&nbsp;&nbsp;</td>
                                                        <td>
                    ...
                    <div class="nk-match">
                        ...
                        <div class="nk-match-status">
                            <div class="nk-match-status-vs">VS</div>
                            <div class="nk-match-status-date">Apr 15, 2016 9:00 pm</div>
                            <div class="nk-match-score bg-success">
                                28 : 19
                            </div>
                        </div>
                        <div class="nk-match-team-right">
