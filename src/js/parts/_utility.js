 ...
 * page border size
 */
let $page_border = $('.nk-page-border .nk-page-border-t');
let pageBorderSize = $page_border.height();
debounceResize(() => {
...
export { $, tween, isIOs, isMobile, isFireFox, isTouch, $wnd, $doc, $body, wndW, wndH, docH, debounceResize, throttleScroll, pageBorderSize, bodyOverflow, isBodyOverflowed, isInViewport, scrollTo };
